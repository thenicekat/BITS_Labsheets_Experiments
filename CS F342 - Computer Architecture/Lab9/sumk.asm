...
main:
    ...
    end_of_loop1:
        ...
        li $a1, 3
        jal countPathWithK                 # call height function
        move $a0, $v0
        li $v0, 1
        syscall
li $v0, 0xa
...
countPathWithK:
    ...
    # Save root address and sum till now
    move $s0, $a0
    move $s1, $a1
    ...
    subu $a1, $a1, $t0
    jal countPathWithK
    add $s2, $v0, $0  # Accumulate result from left subtree
    ...
    subu $a1, $a1, $t0
    jal countPathWithK
    add $s2, $s2, $v0  # Add result from right subtree
...
base:
    li $v0, 0  # Base case: no paths found
...
retu:
    ...
    lw $s2, 12($sp)
    addi $sp, $sp, 16
    move $v0, $s2  # Return the accumulated result
    jr $ra
